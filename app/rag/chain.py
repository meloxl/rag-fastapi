...
from app.config import LLM_API_BASE, LLM_API_KEY, LLM_MODEL, LLM_TEMPERATURE, RETRIEVE_K
...
def _to_sources(documents: list[Document], preview_len: int = 120) -> list[SourceItem]:
